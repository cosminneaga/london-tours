...
<body class="login-background">
	...
	<div class="form-style">
		...
		<form name="theForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
			...
			<div class="inner-wrap" style="border: 2px solid black;">
				Forgot your password? <button style="float: right;"
					onclick="document.location.href='change-pass.php' ">Change Password</button>
			</div>
		</div>

...
if (isset($_REQUEST['admin-user-insert'])) {
    ...
    }else{ echo "Something didn't worked well";}
}
?>
 ...
 <div class="form-centered">
     <div class="form">
        ...
        <form method="POST" action="">
            ...
            Gender:<br>
            <input type="radio" name="gender" <?php if (isset($gender) && $gender == "male") echo "checked"; ?> value="male" ><span id="ciki">Male</span>
            <input type="radio" name="gender" <?php if (isset($gender) && $gender == "female") echo "checked"; ?> value="female"><span id="ciki">Female</span>
            <input type="radio" name="gender" <?php if (isset($gender) && $gender == "other") echo "checked"; ?> value="other" checked><span id="ciki">Other</span>
            <br><br>

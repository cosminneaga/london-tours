...
//$generalErrorMsg = $fnameError = $lnameError = $ageError = $genderError = $telError = $housenoError = $stnameError = $ctnameError = $pcodeError = $unameError = $emailError = $passError = $passMatch = "";
                ...
                if (empty($generalErrorMsg)&&empty($fnameError)&&empty($lnameError)&&empty($ageError)&&empty($genderError)&&empty($telError)&&
...
<div class="form-style">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  <!--$_server["php_self"] method is used to sanitize the form and protect it from external hacking-->
        <div class="section">
            <span>1</span>
        ...
        <div class="inner-wrap">
            <div class="php-msg">
                <?php if($fnameError != "") echo $fnameError ?>
            </div>
            <label>First name<input type="text" name="firstname" value="<?php if(isset($_POST['firstname'])) echo $_POST['firstname'];?>" > </label> 
            <div class="php-msg">
                <?php if($lnameError != "") echo $lnameError ?>
            </div>
            <label>Last Name<input type="text" name="lastname" value="<?php if(isset($_POST['lastname'])) echo $_POST['lastname'];?>"></label>
            <div class="php-msg">
                <?php if($ageError != "") echo $ageError ?>
            </div>
            <label>Age<input type="text" name="age" value="<?php if(isset($_POST['age'])) echo $_POST['age'];?>"></label>
            <div class="php-msg">
                <?php if($genderError != "") echo $genderError ?>
            </div>
            <label>Gender:<br>
        ...
        <div class="inner-wrap">
            <div class="php-msg">
                <?php if($stnameError != "") echo $stnameError ?>
            </div>
           <label>Street Name<input type="text" name="streetname" value="<?php if(isset($_POST['streetname'])) echo $_POST['streetname'];?>"></label>
           <div class="php-msg">
                <?php if($housenoError != "") echo $housenoError ?>
            </div>
           <label>House No.<input type="text" name="housenumber" value="<?php if(isset($_POST['housenumber'])) echo $_POST['housenumber'];?>"></label>
           <div class="php-msg">
                <?php if($pcodeError != "") echo $pcodeError ?>
            </div>
           <label>Postcode<input type="text" name="postcode" value="<?php if(isset($_POST['postcode'])) echo $_POST['postcode'];?>"></label>
           <div class="php-msg">
                <?php if($ctnameError != "") echo $ctnameError ?>
            </div>
           <label>City<input type="text" name="cityname" value="<?php if(isset($_POST['cityname'])) echo $_POST['cityname'];?>"></label>
       </div>
       ...
       <div class="inner-wrap">
        ...
        <label>Email Address <input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email'];?>"></label>
        <div class="php-msg">
            <?php if($telError != "") echo $telError ?>
        </div>
        <label>Phone Number <input type="text" name="telephone" value="<?php if(isset($_POST['telephone'])) echo $_POST['telephone'];?>"></label>
    </div>

    <div class="section"><span>4</span>Username & Passwords</div>
    <div class="inner-wrap">
        <div class="php-msg">
            <?php if($unameError != "") echo $unameError ?>
        ...
        <div class="php-msg">
            <?php if($passError != "") echo $passError ?>
            <?php if($passMatch != "") echo $passMatch ?>
        </div>

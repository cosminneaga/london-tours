		...
		<div class="form">
			<div class="form-title">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					<div class="content">
						<div class="label">
							<p>Please bear in mind to fill all fields correctly, otherwise your password cannot be changed.</p>
							Fill every field below in order to change your password
						</div>
						<div class="inner">
							<div class="php-msg">
								<?php if($generalErrorMessage != "") echo $generalErrorMessage ?>
								<?php if($fnameError != "") echo $fnameError ?>
							</div>
							<label>First Name: <input type="text" name="fname" value="<?php if(isset($_POST['fname'])) echo $_POST['fname']; ?>"></label>
							<div class="php-msg">
								<?php if($lnameError != "") echo $lnameError ?>
							</div>
							<label>Last Name: <input type="text" name="lname" value="<?php if(isset($_POST['lname'])) echo $_POST['lname']; ?>"></label>
							<div class="php-msg">
						...
						<div class="inner">
							<div class="php-msg">
								...
								<?php if($passwordMatch != "") echo $passwordMatch ?>
							</div>
						...
						<div class="label">
							In case you don't remember your details please contact us on <a href="contact.php">Contact Us</a> page
						</div>
					</div>
				</form>
		</div>		
